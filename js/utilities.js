import jsImageCompressor from "https://cdn.jsdelivr.net/npm/js-image-compressor@2.0.0/+esm";
...
export function compressImage(file, onSuccess, onError) {
  new jsImageCompressor({
    file: file,
    quality: 0.6,
    mimeType: "image/jpeg",
    maxWidth: 500,
